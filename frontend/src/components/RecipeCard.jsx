...
export default function RecipeCard({ meal }) {
  return (
    <>
      <Link
        to={`/categories/${meal.title}`}
        className="flex flex-col items-center gap-2  w-full"
      >
        {/*CARDD*/}
        <div
          className="h-[250px] w-[210px] px-2 rounded-2xl border border-black/5 bg-white flex flex-col items-center pt-2  shadow-[0_0_6px_rgba(0,0,0,0.14)]
"
        >
          <img
            src={meal.img}
